...
type ClassService interface {
	CreateClass(ctx context.Context, req models.CreateClassRequest, trainerID int64) error
...
func (s *classService) CreateClass(ctx context.Context, req models.CreateClassRequest, trainerID int64) error {
